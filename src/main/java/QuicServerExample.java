                    ...
                    protected void initChannel(QuicStreamChannel ch)  {
                        ...
                        ch.pipeline()
                            ...
                            public void channelRead(ChannelHandlerContext ctx, Object msg) {
                                ...
                                try {
                                    System.out.printf("read length:%d, read str:%s\n", byteBuf.writerIndex(), byteBuf.toString(CharsetUtil.US_ASCII).trim());
                                    if (byteBuf.toString(CharsetUtil.US_ASCII).trim().equals("GET123456789012345678901234567890GET12345678901234567890123456789012")) {
